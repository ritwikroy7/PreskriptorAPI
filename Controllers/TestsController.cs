    ...
    public class TestsController:Controller
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            else
            {
                ...
                _distributedCache.SetString(cacheKey, JsonConvert.SerializeObject(testList, new JsonSerializerSettings { ContractResolver = new CamelCasePropertyNamesContractResolver()}),cacheEntryOptions);
                if(testList.Count!=0)
                {
                    return Ok(testList);
                }
